"""
Lightweight GPT-2 style transformer model implementation
"""
...
class LightLLM(nn.Module):
    def __init__(self, config: ModelConfig):
        ...
        assert config.n_positions is not None
        self.config = config
...
if __name__ == "__main__":
    ...
    # Test forward pass
    x = torch.randint(0, config.vocab_size, (2, 10))  # batch=2, seq_len=10
